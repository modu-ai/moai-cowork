...
- **PRD·기능 명세 작성** → moai-product:spec-writer 스킬이 더 적합합니다
- **고객 CS 응답 초안 작성** → moai-support:draft-response 스킬을 사용하세요
- **마케팅 데이터 분석** → moai-marketing:performance-report 스킬이 더 적합합니다
- **실제 설문 발송 또는 인터뷰 진행** → 구글폼, 카카오폼, Typeform 등을 직접 사용하세요
