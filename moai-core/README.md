...
스킬을 자연어로 트리거하는 중앙 허브입니다. 사용자 요청을 자동 감지하여 17개 플러그인의 전문 스킬로 즉시 라우팅합니다. `/moai init`으로 프로젝트 맞춤형 `CLAUDE.md`를 생성하고, `/moai catalog`로 전체 스킬 목록을 조회합니다.
