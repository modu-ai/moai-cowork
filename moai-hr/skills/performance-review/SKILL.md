...
description: >
  성과평가 설계·실행 — MBO·OKR·KPI 체계 구축, 360도 평가, 인사 고과 가이드, 피드백 면담 스크립트 작성.
user-invocable: true
metadata:
  version: "1.0.0"
  status: "active"
...
2026년 한국 기업 트렌드인 OKR+KPI 병행 운영, AI 기반 성과 분석, 360도 피드백을 반영하며 근로기준법 준수 기반의 공정한 평가 프로세스를 구축한다.
