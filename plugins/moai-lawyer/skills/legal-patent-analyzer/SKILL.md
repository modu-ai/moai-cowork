...
특허 데이터를 체계적으로 분석하여 기술 동향, 선행기술 보고서, FTO(Freedom-to-Operate) 분석, 특허 출원서 초안을 작성하는 전문 스킬입니다. moai-lawyer:legal-patent-search 스킬로 검색한 특허 데이터를 바탕으로 심층 분석을 수행합니다.
...
2. 관련 특허 검색 (moai-lawyer:legal-patent-search 스킬 연계)
   - 구성요소별 개별 검색
...
| 파일 | 로드 조건 |
|------|-----------|
| references/patent-analyzer/guide.md | 선행기술 조사 보고서 구조·유사도 분석·신규성 판단 등 특허 분석 상세 가이드가 필요할 때 |
