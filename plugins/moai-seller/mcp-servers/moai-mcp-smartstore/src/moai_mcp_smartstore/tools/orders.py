...
def order_list_by_order(order_id: str) -> dict:
    ...
    return call(
        "GET",
        f"/v1/pay-order/seller/orders/{segment(order_id)}/product-order-ids",
    )
...
def order_delay(product_order_id: str, body: dict[str, Any]) -> dict:
    ...
    return call("POST", f"{_PO}/{segment(product_order_id)}/delay", body=body)
...
def order_change_hope_delivery(product_order_id: str, body: dict[str, Any]) -> dict:
    ...
    return call("POST", f"{_PO}/{segment(product_order_id)}/hope-delivery/change", body=body)
...
def order_cancel_request(product_order_id: str, body: dict[str, Any]) -> dict:
    ...
    return call("POST", f"{_PO}/{segment(product_order_id)}/claim/cancel/request", body=body)
...
def order_cancel_approve(product_order_id: str, body: dict[str, Any] | None = None) -> dict:
    ...
    return call("POST", f"{_PO}/{segment(product_order_id)}/claim/cancel/approve", body=body or {})
...
def order_return_request(product_order_id: str, body: dict[str, Any]) -> dict:
    ...
    return call("POST", f"{_PO}/{segment(product_order_id)}/claim/return/request", body=body)
...
def order_return_approve(product_order_id: str, body: dict[str, Any] | None = None) -> dict:
    ...
    return call("POST", f"{_PO}/{segment(product_order_id)}/claim/return/approve", body=body or {})


@mcp.tool()
def order_return_reject(product_order_id: str, body: dict[str, Any]) -> dict:
    """반품 요청 거부/철회(거부사유코드+안내메시지). POST .../{id}/claim/return/reject"""
    return call("POST", f"{_PO}/{segment(product_order_id)}/claim/return/reject", body=body)
...
def order_return_holdback(product_order_id: str, body: dict[str, Any] | None = None) -> dict:
    ...
    return call("POST", f"{_PO}/{segment(product_order_id)}/claim/return/holdback", body=body or {})
...
def order_return_holdback_release(product_order_id: str, body: dict[str, Any] | None = None) -> dict:
    ...
    return call(
        "POST",
        f"{_PO}/{segment(product_order_id)}/claim/return/holdback/release",
        body=body or {},
    )
...
def order_exchange_collect_approve(product_order_id: str, body: dict[str, Any] | None = None) -> dict:
    ...
    return call(
        "POST",
        f"{_PO}/{segment(product_order_id)}/claim/exchange/collect/approve",
        body=body or {},
    )
...
def order_exchange_dispatch(product_order_id: str, body: dict[str, Any]) -> dict:
    ...
    return call("POST", f"{_PO}/{segment(product_order_id)}/claim/exchange/dispatch", body=body)
...
def order_exchange_holdback(product_order_id: str, body: dict[str, Any] | None = None) -> dict:
    ...
    return call("POST", f"{_PO}/{segment(product_order_id)}/claim/exchange/holdback", body=body or {})
...
def order_exchange_holdback_release(product_order_id: str, body: dict[str, Any] | None = None) -> dict:
    ...
    return call(
        "POST",
        f"{_PO}/{segment(product_order_id)}/claim/exchange/holdback/release",
        body=body or {},
    )
...
def order_exchange_reject(product_order_id: str, body: dict[str, Any]) -> dict:
    ...
    return call("POST", f"{_PO}/{segment(product_order_id)}/claim/exchange/reject", body=body)
