...
TOOLS_DIR = Path(__file__).resolve().parent  # mcp-servers/moai-mcp-imweb/tools/
ROOT = TOOLS_DIR.parent  # mcp-servers/moai-mcp-imweb/
SPEC_FILE = TOOLS_DIR / "openapi.json"
OUT_DIR = ROOT / "src" / "moai_mcp_imweb" / "tools"
