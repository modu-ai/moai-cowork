...
doc-html-slide의 단일 `.html` 파일에 인라인되는 **자체 제작 vanilla JS 덱 런타임**입니다. 외부 프레임워크(reveal.js/Marp/Spectacle) 없이 `file://`로 즉시 오픈되는 것이 원칙입니다. doc-html-report의 0의존 원칙을 슬라이드 시퀀스로 확장합니다.
...
> 이 경로는 **PDF** 산출입니다. 편집 가능 **PPTX**는 doc-pptx 체이닝으로 산출합니다 (`references/pptx-chaining.md`).
